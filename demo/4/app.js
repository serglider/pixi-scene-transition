...
function onFirstSceneClick(scene1, scene2) {
    const trans = PIXI.SceneTransitionManager.createShapeTransition(scene1, scene2, {
...
function onSecondSceneClick(scene1, scene2) {
    const trans = PIXI.SceneTransitionManager.createShapeTransition(scene2, scene1, {
